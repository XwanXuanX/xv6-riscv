...
[[maybe_unused]] static uint64 r_mhartid() {
    uint64 x;
...
[[maybe_unused]] static uint64 r_mstatus() {
    uint64 x;
    asm volatile("csrr %0, mstatus" : "=r"(x));
    return x;
}

[[maybe_unused]] static void w_mstatus(uint64 x) {
...
// exception will go.
[[maybe_unused]] static void w_mepc(uint64 x) {
...
[[maybe_unused]] static uint64 r_sstatus() {
    uint64 x;
    asm volatile("csrr %0, sstatus" : "=r"(x));
    return x;
}

[[maybe_unused]] static void w_sstatus(uint64 x) {
    asm volatile("csrw sstatus, %0" : : "r"(x));
}

// Supervisor Interrupt Pending
[[maybe_unused]] static uint64 r_sip() {
    uint64 x;
    asm volatile("csrr %0, sip" : "=r"(x));
    return x;
}

[[maybe_unused]] static void w_sip(uint64 x) {
...
[[maybe_unused]] static uint64 r_sie() {
    uint64 x;
    asm volatile("csrr %0, sie" : "=r"(x));
    return x;
}

[[maybe_unused]] static void w_sie(uint64 x) {
    asm volatile("csrw sie, %0" : : "r"(x));
}

// Machine-mode Interrupt Enable
#define MIE_STIE (1L << 5) // supervisor timer
[[maybe_unused]] static uint64 r_mie() {
    uint64 x;
    asm volatile("csrr %0, mie" : "=r"(x));
    return x;
}

[[maybe_unused]] static void w_mie(uint64 x) {
...
// instruction address to which a return from
// exception will go.
[[maybe_unused]] static void w_sepc(uint64 x) {
    asm volatile("csrw sepc, %0" : : "r"(x));
}

[[maybe_unused]] static uint64 r_sepc() {
    uint64 x;
...
[[maybe_unused]] static uint64 r_medeleg() {
    uint64 x;
...
#define PA2_PTE(pa) ((((uint64)pa) >> 12) << 10)

#define PTE2_PA(pte) (((pte) >> 10) << 12)
